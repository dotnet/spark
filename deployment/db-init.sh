...
# SPARKDOTNET_RELEASE to point to the appropriate version you downloaded from the
...
SPARKDOTNET_RELEASE=https://github.com/dotnet/spark/releases/download/v0.2.0/Microsoft.Spark.Worker.netcoreapp2.1.linux-x64-0.2.0.tar.gz

# No need to change this unless you choose to use a different location
DBFS_INSTALLATION_ROOT=/dbfs/spark-dotnet
SPARKDOTNET_WORKER_INSTALLATION_PATH=/usr/local/bin

###############################################################################

set +e
/bin/bash $DBFS_INSTALLATION_ROOT/$SPARKDOTNET_RELEASE github $DBFS_INSTALLATION_ROOT/$SPARKDOTNET_RELEASE $SPARKDOTNET_WORKER_INSTALLATION_PATH
