...
namespace Microsoft.Spark.Sql
{
    ...
    public static class Functions
    {
        ...
        /// A delegate that returns a <see cref="Column"/> for the result of the UDF.
        /// </returns>
        public static Func<Column, Column> Udf<A1, RT>(Func<A1, RT> udf)
        {
        ...
        /// A delegate that returns a <see cref="Column"/> for the result of the UDF.
        /// </returns>
        public static Func<Column, Column, Column> Udf<A1, A2, RT>(Func<A1, A2, RT> udf)
        {
        ...
        /// A delegate that returns a <see cref="Column"/> for the result of the UDF.
        /// </returns>
        public static Func<Column, Column, Column, Column> Udf<A1, A2, A3, RT>(
        ...
        /// A delegate that returns a <see cref="Column"/> for the result of the UDF.
        /// </returns>
        public static Func<Column, Column, Column, Column, Column> Udf<A1, A2, A3, A4, RT>(
        ...
        /// A delegate that returns a <see cref="Column"/> for the result of the UDF.
        /// </returns>
        public static Func<Column, Column, Column, Column, Column, Column> Udf<A1, A2, A3, A4, A5, RT>(
        ...
        /// A delegate that returns a <see cref="Column"/> for the result of the UDF.
        /// </returns>
        public static Func<Column, Column, Column, Column, Column, Column, Column> Udf<A1, A2, A3, A4, A5, A6, RT>(
        ...
        /// A delegate that returns a <see cref="Column"/> for the result of the UDF.
        /// </returns>
        public static Func<Column, Column, Column, Column, Column, Column, Column, Column> Udf<A1, A2, A3, A4, A5, A6, A7, RT>(
        ...
        /// A delegate that returns a <see cref="Column"/> for the result of the UDF.
        /// </returns>
        public static Func<Column, Column, Column, Column, Column, Column, Column, Column, Column> Udf<A1, A2, A3, A4, A5, A6, A7, A8, RT>(
        ...
        public static Func<Column, Column, Column, Column, Column, Column, Column, Column, Column, Column> Udf<A1, A2, A3, A4, A5, A6, A7, A8, A9, RT>(
