...
namespace Microsoft.Spark.Sql
{
    ...
    internal sealed class ArrowUdfWrapper<T, TResult> : IUdfWrapper
        where T : IArrowArray
    ...
    /// <typeparam name="TResult">Specifies the return type of the UDF.</typeparam>
    internal sealed class ArrowUdfWrapper<T1, T2, TResult> : IUdfWrapper
    ...
    /// <typeparam name="TResult">Specifies the return type of the UDF.</typeparam>
    internal sealed class ArrowUdfWrapper<T1, T2, T3, TResult> : IUdfWrapper
        where T1 : IArrowArray
        where T2 : IArrowArray
    ...
    /// <typeparam name="TResult">Specifies the return type of the UDF.</typeparam>
    internal sealed class ArrowUdfWrapper<T1, T2, T3, T4, TResult> : IUdfWrapper
        where T1 : IArrowArray
        where T2 : IArrowArray
        where T3 : IArrowArray
    ...
    /// <typeparam name="TResult">Specifies the return type of the UDF.</typeparam>
    internal sealed class ArrowUdfWrapper<T1, T2, T3, T4, T5, TResult> : IUdfWrapper
        where T1 : IArrowArray
        where T2 : IArrowArray
        where T3 : IArrowArray
        where T4 : IArrowArray
    ...
    /// <typeparam name="TResult">Specifies the return type of the UDF.</typeparam>
    internal sealed class ArrowUdfWrapper<T1, T2, T3, T4, T5, T6, TResult> : IUdfWrapper
        where T1 : IArrowArray
        where T2 : IArrowArray
        where T3 : IArrowArray
        where T4 : IArrowArray
    ...
    /// <typeparam name="TResult">Specifies the return type of the UDF.</typeparam>
    internal sealed class ArrowUdfWrapper<T1, T2, T3, T4, T5, T6, T7, TResult> : IUdfWrapper
        where T1 : IArrowArray
        where T2 : IArrowArray
        where T3 : IArrowArray
        where T4 : IArrowArray
    ...
    /// <typeparam name="TResult">Specifies the return type of the UDF.</typeparam>
    internal sealed class ArrowUdfWrapper<T1, T2, T3, T4, T5, T6, T7, T8, TResult> : IUdfWrapper
        where T1 : IArrowArray
        where T2 : IArrowArray
        where T3 : IArrowArray
        where T4 : IArrowArray
